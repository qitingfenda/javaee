...
public class RSACoderUtil {
    ...
    public void test01() throws Exception {
        // 原文
        String str = "这是一段原文:XXXX";
        String publicKey = "/nMFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAK4qx+tj0ePvci0VJMNbFdsZMD+3BLFdBD5DZIH1xIgFYJovlfqnX/okKDV1VKfoj0P7EkDetf211LUC5Db3SmkCAwEAAQ==";
        byte[] str1 = RSACoderUtil.encryptByPublicKey(str.getBytes(), publicKey.getBytes());
        System.out.println(Base64.encodeBase64String(str1));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        //乙方进行数据的解密
        byte[] decode1 = RSACoderUtil.decryptByPublicKey(code1, publicKey);
